...
<body>
        <div class="container d-flex justify-content-center align-items-center mt-3">
                <div class="card text-center" style="width: 750px;">
                        ...
                        <input class="d-none" type="file" name="img[]" id="imageUpload" accept="image/png, image/jpeg"  onchange="success()" required>
                        </div>
                        <div class="btn btn-outline-secondary btn-rounded m-2">
                        <img  class="profile-cover" src="images\addImage.png" id="profileImage2" style="width:200px;">
                        <input class="d-none" type="file" name="img[]" id="imageUpload2" accept="image/png, image/jpeg" onchange="success()" required>
                        </div> <br>
                        <div class="btn btn-outline-secondary btn-rounded m-2">
                        <img   class="profile-cover" src="images\addImage.png" id="profileImage3" style="width:200px;">
                        <input class="d-none" type="file" name="img[]" id="imageUpload3" accept="image/png, image/jpeg" onchange="success()" required>
                        </div>
                        <div class="btn btn-outline-secondary btn-rounded m-2">
                        <img class="profile-cover" src="images\addImage.png" id="profileImage4" style="width:200px;">
                        <input class="d-none" type="file" name="img[]" id="imageUpload4" accept="image/png, image/jpeg" onchange="success()" required>
                        </div>
