  ...
  <body>
            ...
            <div class="collapse" id="filter">
              ...
              <form name="form" method="GET" action="index.php">
                <div class="input-group">
                    ...
                    <select class="form-control" id="sexSelect" name="sexSelect" class="form-select form-select-sm" aria-label=".form-select-sm example">
                    <option value="Male">Male</option>
                    <option value="Female">Female</option>
                    <option selected value="Everything">Everyone</option>
                    </select> 
    ...
    <script>
      ...
      function matchClicked(flag){
        ...
        if(mimg1.src == "https://ite4-bsit-ab.com/bsit4b/chooseph/images/")
          mimg1.style.display='none';
        if(mimg2.src == "https://ite4-bsit-ab.com/bsit4b/chooseph/images/")
          mimg2.style.display='none';
        if(mimg3.src == "https://ite4-bsit-ab.com/bsit4b/chooseph/images/")
          mimg3.style.display='none';
        if(mimg4.src == "https://ite4-bsit-ab.com/bsit4b/chooseph/images/")
