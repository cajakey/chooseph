...
<body>
        <div class="container d-flex justify-content-center align-items-center mt-3">
                <div class="card text-center" style="width: 750px;">
                        ...
                        <input value = "<?php echo $imageArray[0];?>" class="d-none" type="file" name="img[]" id="imageUpload" accept="image/png, image/jpeg">
                        </div>
                        <div class="btn btn-outline-secondary btn-rounded m-2">
                        ...
                        <input  class="d-none" type="file" name="img[]" id="imageUpload2" accept="image/png, image/jpeg">
                        </div> <br>
                        <div class="btn btn-outline-secondary btn-rounded m-2">
                        ...
                        <input class="d-none" type="file" name="img[]" id="imageUpload3" accept="image/png, image/jpeg">
                        </div>
                        <div class="btn btn-outline-secondary btn-rounded m-2">
                        ...
                        <input  class="d-none" type="file" name="img[]" id="imageUpload4" accept="image/png, image/jpeg">
                        </div>
